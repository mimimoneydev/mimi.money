...
describe("openCode models", () => {
    ...
    it("honours OPENCODE_ALLOW_ALL_MODELS from the process env", async () => {
        ...
        await expect(ensureOpenCodeModelConfiguredAndAvailable({ model: "anthropic/gateway/some-model" })).resolves.toEqual([{ id: "anthropic/gateway/some-model", label: "anthropic/gateway/some-model" }]);
    });
