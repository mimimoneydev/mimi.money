...
export declare function requireOpenCodeModelId(input: unknown): string;
export declare function parseOpenCodeModelsOutput(stdout: string): AdapterModel[];
...
export declare function isTruthyEnvFlag(value: string | undefined): boolean;
