...
import { ensurePaperclipSkillSymlink, resolvePaperclipInstanceRootForAdapter, } from "@paperclipai/adapter-utils/server-utils";
...
function resolveManagedClaudePromptCacheRoot(env, companyId) {
    ...
    return path.resolve(instanceRoot, "companies", companyId, "claude-prompt-cache");
}
