...
import { claudeModelUsageTotals, parseClaudeStreamJson, detectClaudeLoginRequired, extractClaudeRetryNotBefore, isClaudeProviderQuotaError, isClaudeTransientUpstreamError, isClaudePoisonedPreviousMessageIdError, isClaudeRefusalResult, isClaudeUnknownSessionError, isClaudeImageProcessingError, isClaudeModelNotFoundError, } from "./parse.js";
...
describe("isClaudeTransientUpstreamError", () => {
    it("classifies the 'out of extra usage' subscription window failure as provider quota", () => {
        expect(isClaudeProviderQuotaError({
    ...
    it("classifies Claude session-limit windows as provider quota and extracts the retry time", () => {
        ...
        expect(extractClaudeRetryNotBefore({ errorMessage }, now)?.toISOString()).toBe("2026-04-22T21:00:00.000Z");
    });
...
describe("parseClaudeStreamJson usage extraction", () => {
    const resultEvent = (extra) => JSON.stringify({
        type: "result",
        subtype: "success",
        session_id: "sess-1",
        result: "done",
