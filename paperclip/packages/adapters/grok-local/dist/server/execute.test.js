...
vi.mock("@paperclipai/adapter-utils/execution-target", () => ({
    ...
    adapterExecutionTargetRemoteCwd: (_target, cwd) => cwd,
    overrideAdapterExecutionTargetRemoteCwd: (target, _cwd) => target,
    ...
    readAdapterExecutionTarget: ({ executionTarget }) => executionTarget ?? { kind: "local" },
    resolveAdapterExecutionTargetCommandForLogs: resolveCommandForLogsMock,
    resolveAdapterExecutionTargetTimeoutSec: (_target, timeoutSec) => timeoutSec,
