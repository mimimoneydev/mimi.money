...
vi.mock("@paperclipai/adapter-utils/execution-target", () => ({
    ...
    resolveAdapterExecutionTargetCwd: (_target, configuredCwd, fallbackCwd) => configuredCwd || fallbackCwd,
...
describe("grok_local testEnvironment", () => {
    ...
    it("reports a healthy authenticated host with a working hello probe", async () => {
        ...
        expect(runProcessMock).toHaveBeenNthCalledWith(2, expect.any(String), null, "grok", expect.arrayContaining([
            "--output-format",
            "streaming-json",
            "--always-approve",
            "--permission-mode",
