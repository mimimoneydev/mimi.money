...
import { type CodexAuthRefreshFailureClass } from "./parse.js";
...
export declare function readCodexQuotaErrorFamily(error: unknown): CodexAuthRefreshFailureClass | null;
