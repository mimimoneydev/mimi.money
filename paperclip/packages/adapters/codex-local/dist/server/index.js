...
export { resolveCodexAuthPrecedence, CODEX_SANDBOX_AUTH_PRECEDENCE_WARNING, CODEX_SANDBOX_AUTH_PRECEDENCE_WARNING_LOG_LINE, CODEX_SANDBOX_AUTH_EXISTS_COMMAND, } from "./auth-precedence.js";
export * from "./acp.js";
export { getConfigSchema } from "./config-schema.js";
export { reconcileManagedCodexHome, isManagedCodexHomePath, evaluateCodexCredentialReadiness, } from "./codex-home.js";
...
export const sessionCodec = {
    deserialize(raw) {
        ...
        if (!sessionId)
            return acpxSessionCodec.deserialize(raw);
    ...
    serialize(params) {
        ...
        if (!sessionId)
            return acpxSessionCodec.serialize(params);
