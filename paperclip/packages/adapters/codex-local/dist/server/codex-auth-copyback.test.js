...
describe("copyBackCodexAuth", () => {
    ...
    async function runCopyBack(input) {
        ...
        const readSandboxAuth = typeof input.sandboxAuth === "function"
            ? input.sandboxAuth
            : async () => Buffer.from(input.sandboxAuth, "utf8");
        const logs = [];
...
//# sourceMappingURL=codex-auth-copyback.test.js.map