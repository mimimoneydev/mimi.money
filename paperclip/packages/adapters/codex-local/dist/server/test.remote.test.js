...
const { ensureAdapterExecutionTargetDirectory, ensureAdapterExecutionTargetCommandResolvable, maybeRunSandboxInstallCommand, runAdapterExecutionTargetProcess, describeAdapterExecutionTarget, resolveAdapterExecutionTargetCwd, prepareAdapterExecutionTargetRuntime, prepareManagedCodexHome, restoreWorkspace, capturedHomeAssetFiles, } = vi.hoisted(() => {
    ...
    const capturedHomeAssetFiles = { value: null };
    return {
        ...
        prepareAdapterExecutionTargetRuntime: vi.fn(async (input) => {
