...
const sandboxAuthFixture = { bytes: Buffer.from("{}") };
const REMOTE_RUNTIME_ROOT = "/remote/workspace/.paperclip-runtime/codex";
const { runChildProcess, ensureCommandResolvable, resolveCommandForLogs, prepareAdapterExecutionTargetRuntime, startAdapterExecutionTargetPaperclipBridge, } = vi.hoisted(() => ({
