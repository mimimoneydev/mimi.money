...
export function resolveProvider(options) {
    const { explicitProvider, detectedProvider, detectedModel, detectedBaseUrl, detectedHasApiKey, detectedApiMode, model, } = options;
    ...
    const configMatchesRequestedModel = !!detectedModel &&
        !!model &&
    ...
    if (configMatchesRequestedModel &&
        !!detectedProvider &&
