...
export declare function resolveHermesCommand(config: Record<string, unknown>): string;
export declare function buildPrompt(ctx: AdapterExecutionContext, config: Record<string, unknown>, options?: {
