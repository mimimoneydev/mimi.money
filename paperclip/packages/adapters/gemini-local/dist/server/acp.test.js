...
import { buildGeminiAcpConfig, createGeminiAcpExecutor, nodeVersionMeetsGeminiAcpMinimum, resolveGeminiExecutionEngine, resolveGeminiExecutionEngineForRun, testGeminiAcpEnvironment, } from "./acp.js";
const tempRoots = [];
...
describe("gemini_local ACP lane", () => {
    ...
    it("defaults to ACP when prerequisites pass and falls back to CLI only for auto resolution", async () => {
        ...
        await expect(resolveGeminiExecutionEngineForRun({
