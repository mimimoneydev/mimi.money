...
import { createGeminiAcpExecutor, formatGeminiAcpFallbackMessage, resolveGeminiExecutionEngineForRun, } from "./acp.js";
...
export async function execute(ctx) {
    ...
    if (engineSelection.engine === "acp") {
        try {
            ...
            await ctx.onLog("stderr", formatGeminiAcpFallbackMessage(`Gemini ACP startup failed: ${reason}`));
        }
    }
