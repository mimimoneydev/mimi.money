...
export declare function isGeminiSessionUnrecoverableError(stdout: string, stderr: string): boolean;
export declare function isGeminiTransientNetworkError(stdout: string, stderr: string): boolean;
