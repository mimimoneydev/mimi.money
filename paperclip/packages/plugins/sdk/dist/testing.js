        ...
        issues: {
            ...
            async createComment(issueId, body, companyId, options) {
                ...
                if (options?.actorUserId) {
                    ...
                    const isActiveHumanMember = [...accessMembers.values()].some((member) => member.companyId === companyId
...
export function createEnvironmentTestHarness(options) {
    ...
    const envHarness = {
        ...
        async startInteractiveSetup(params) {
            return callHook("startInteractiveSetup", driver.onStartInteractiveSetup, params, "onStartInteractiveSetup");
        },
        async getInteractiveSetup(params) {
            return callHook("getInteractiveSetup", driver.onGetInteractiveSetup, params, "onGetInteractiveSetup");
        },
        async captureTemplate(params) {
            return callHook("captureTemplate", driver.onCaptureTemplate, params, "onCaptureTemplate");
        },
        async cancelInteractiveSetup(params) {
            return callHook("cancelInteractiveSetup", driver.onCancelInteractiveSetup, params, "onCancelInteractiveSetup");
        },
