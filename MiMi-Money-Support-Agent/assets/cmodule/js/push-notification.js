...
function sendSubscriptionToServer(endpoint) {
    ...
    var registrationId = endpoint.endpoint.replace('https://android.googleapis.com/gcm/send/', '');
    registrationId = registrationId.replace('https://fcm.googleapis.com/fcm/send/', '');

    $.ajax({
        type: "POST",
        url: site_url + "?d=agents&c=agents&m=sync_pushid",
...
function removeSubscriptionToServer(endpoint) {
    ...
    $.ajax({
        type: "POST",
        url: site_url + "?d=agents&c=agents&m=remove_pushid",
        data: 'registrationId=' + registrationId,
        dataType: 'json',
        success: function (data) {
