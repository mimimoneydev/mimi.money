package com.money.mimi.adapters.recyclerView.groups;
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        try {
            ...
            if (membersGroupModel.getUsername() != null) {
                ...
                try {
                    if (membersGroupModel.getUserId() == PreferenceManager.getID(mActivity)) {
                        ...
                        String name = UtilsPhone.getContactName(membersGroupModel.getWalletAddress());
                        if (name != null) {
                            contactsViewHolder.setUsername(name);
                        } else {
                            contactsViewHolder.setUsername(membersGroupModel.getWalletAddress());
                        }
            ...
            if (membersGroupModel.getStatus() != null) {
                ...
                contactsViewHolder.setStatus(membersGroupModel.getWalletAddress());
            }
        ...
        contactsViewHolder.setOnClickListener(view -> {
            ...
            if (isAdmin) {
                ...
                if (name != null) {
                    ...
                    TheName = membersGroupModel.getWalletAddress();
                }
                ...
                builder.setItems(options, (dialog, which) -> {
                    switch (which) {
                        case 0:
                            ...
                            break;
                        case 1:
                            contactsViewHolder.viewContact(membersGroupModel.getWalletAddress());
                            break;
                        case 2:
                            if (membersGroupModel.isAdmin()) {
