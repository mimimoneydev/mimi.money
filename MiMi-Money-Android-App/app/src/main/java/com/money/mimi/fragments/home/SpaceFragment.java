...
public class SpaceFragment extends Fragment {
    ...
    private static final String DEFAULT_URL = "https://www.geto.space";
    ...
    private static final String USER_AGENT = "Mozilla/5.0 (Linux; Android 12; Pixel 6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Mobile Safari/537.36";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        // view exists instead of waiting until the user first selects Space.
    ...
    private void configureWebView() {
        ...
        webView.setWebViewClient(new WebViewClient() {
            ...
            public void onReceivedError(WebView v, WebResourceRequest req, WebResourceError err) {
                ...
                // Subresource failures such as a polling socket should not be treated as page failures.
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M && req != null && err != null) {
                    ...
                    if (isMainFrame) Log.e(TAG, message);
            ...
            public void onShowCustomView(View view, CustomViewCallback callback) {
                try {
                    ...
                    if (getActivity() instanceof MainActivity) {
                        ((MainActivity) getActivity()).enterSpaceFullscreen();
                        isUiFullscreen = true;
                    }
                } catch (Exception ex) {
