...
import com.money.mimi.adapters.recyclerView.groups.AddMembersToGroupAdapter;
import com.money.mimi.adapters.recyclerView.groups.AddMembersToGroupSelectorAdapter;
...
import com.money.mimi.presenters.groups.AddMembersToGroupPresenter;
            ...
            if (v.getId() == R.id.container_list_item) {
                ...
                if (mAddMembersToGroupListAdapter.getSelectedItemCount() != 0) {
                    ...
                    for (int x = 0; x < arraySize; x++) {
                        ...
                        String phone = mAddMembersToGroupListAdapter.getContacts().get(position).getWalletAddress();
                        ...
                        membersGroupModel.setWalletAddress(phone);
