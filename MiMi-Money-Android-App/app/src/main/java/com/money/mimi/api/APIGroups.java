...
public interface APIGroups {
    ...
    Observable<GroupResponse> createGroup(@Part("userID") int userID,
                                          ...
                                          @Part("notification_key") RequestBody notificationKey,
    ...
    Observable<GroupsModel> getGroup(@Query("groupID") int groupID);
    ...
    Observable<List<MembersGroupModel>> groupMembers(@Query("groupID") int groupID);
    ...
    Observable<GroupResponse> deleteGroup(@Query("groupID") int groupID);
    ...
    Observable<GroupResponse> exitGroup(@Query("groupID") int groupID);
